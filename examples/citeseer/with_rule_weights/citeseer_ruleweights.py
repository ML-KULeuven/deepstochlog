...
from examples.citeseer.with_rule_weights.citeseer_data_withrules import train_dataset, valid_dataset, test_dataset, queries_for_model, citations, pretraining_data
...
def run(
    ...
    model = DeepStochLogModel.from_file(
        file_location=str((root_path / "citeseer_ruleweights.pl").absolute()),
