...
from examples.citeseer.with_rule_weights_xy.citeseer_data_withrules import train_dataset, valid_dataset, test_dataset, queries_for_model, citations
...
def run(
    ...
    xy_switch = RuleWeights(num_rules=6, num_classes=6)
    ...
    networks = NetworkStore(classifier_network, rule_weight,xy_switch)
