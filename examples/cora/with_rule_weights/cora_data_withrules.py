...
class CoraDataset(ContextualizedTermDataset):
    def __init__(
        self,
        split: str,
        labels,
...
train_dataset = CoraDataset(split="train", documents=documents, labels=labels)
valid_dataset = CoraDataset(split="valid", documents=documents, labels=labels)
test_dataset = CoraDataset(split="test", documents=documents, labels=labels)
